...
const Header = () => {
  ...
  return (
    <header className="relative">
        ...
        <div className="w-full px-4 md:w-[calc(100%-25px)] md:max-w-[2400px] mx-auto">
          <div className="flex items-center justify-between py-4">
            ...
            <div className="flex items-center gap-3">
              <Link 
                href={isMobile 
                  ? "https://www.chaturbate.lat/accounts/register/?tour=NwNd&campaign=lRUVu&track=CLfootermodels"
                  : "https://www.chaturbate.lat/accounts/register/?tour=07kX&campaign=lRUVu&track=chatlatfooter"
                }
              ...
              {!isMobile && (
                <Link 
                  href="https://www.chaturbate.lat/auth/login/"
                  rel="nofollow noreferrer noopener"
                >
                  <Button 
                    variant="outline" 
      ...
      <div 
        className="w-full bg-[#0C6B94] sticky top-0"
        style={{
          zIndex: 40,
        }}
      >
