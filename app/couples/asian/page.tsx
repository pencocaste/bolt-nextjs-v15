...
export const metadata: Metadata = {
  title: 'Chaturbate Asian Couples Cams ❤️ Live Sex Chat on Chaturbate.Lat',
  ...
  alternates: {
    canonical: 'https://chaturbate.lat/couples/asian/',
  },
};
...
export default async function AsianPage() {
  const initialModels = await fetchModels('couples', 1, 36, 'asian');
