...
export const metadata: Metadata = {
  title: 'Chaturbate Asian Male Cams ❤️ Live Sex Chat on Chaturbate.Lat',
  ...
  alternates: {
    canonical: 'https://chaturbate.lat/men/asian/',
  },
};
...
export default async function AsianPage() {
  const initialModels = await fetchModels('men', 1, 36, 'asian');
