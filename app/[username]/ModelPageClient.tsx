...
export default function ModelPageClient({ username, initialModel }: ModelPageClientProps) {
  ...
  const embedCode = isMobile 
    ? `<iframe src="https://www.chaturbate.lat/in/?tour=9oGW&campaign=lRUVu&track=embed&room=${username}&disable_sound=1&mobileRedirect=auto&embed_video_only=1" style="width:100%; aspect-ratio:16/9;" frameborder="0" class="code" scrolling="no"></iframe>`
    : `<iframe src="https://www.chaturbate.lat/in/?tour=Limj&campaign=lRUVu&track=embed&signup_notice=1&b=${username}&disable_sound=1&mobileRedirect=never" height="720px" width="1280px" frameborder="0" class="code" scrolling="no"></iframe>`;
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex justify-center mb-8">
        <Button 
          ...
          onClick={() => window.open(`https://www.chaturbate.lat/in/?tour=dT8X&campaign=lRUVu&track=SSSbutton&room=${username}`, '_blank')}
        >
