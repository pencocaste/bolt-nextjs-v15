...
export async function generateMetadata({ params }: { params: { username: string } }): Promise<Metadata> {
  return {
    title: `${params.username} Live Sex Cam on Chaturbate.Lat ❤️`,
    description: `Watch ${params.username}'s Live Sex Cam Show on Chaturbate. ⭐ Join Now for Free and Chat with ${params.username}!`,
    alternates: {
      canonical: `https://chaturbate.lat/${params.username}/`,
    },
  };
}
